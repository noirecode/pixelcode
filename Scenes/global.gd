...
var data = {
	...
	"level_solutions": {
		...
		"Level1" = [0, [5,6,10],1, false], 
		"Level2" = [0, [10,12,15],1, false],
		"Level3" = [0, [12,15,20],1, false],
		"Level4" = [0, [5,5,10],1, false],
		"Level5" = [0, [8,13,17],1, false],
		"Level6" = [0, [12,15,20],1, false],
		"Level7" = [0, [9,9,11],1, false],
		"Level8" = [0, [11,13,15],1, false],
		"Level9" = [0, [8,9,13],1, false],
		"Level10" = [0, [21,23,25],1, false],
		"Level11" = [0, [20,20,23],1, false],
		"Level12" = [0, [14,15,17],1, false],
		"Level13" = [0, [12,15,17],1, false],
